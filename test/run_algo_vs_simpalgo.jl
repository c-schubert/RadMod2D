...
@time t_occ = get_occmat_of_elements_in_tilegrid(m, dx, dy, n, blockparts = 1:(m.no_parts-1))
...
plot_model(fig, ax, m, show_norm_vec = true, show_nodes = false, show_com = false, show_leg = false)
display(fig)
